...
@NgModule({
  ...
  declarations: [...declarations, AgricultureFarmingComponent, AutomotiveComponent, ChemicalComponent, CraftBreweriesComponent, DefenceComponent, FoodBeverageComponent, IndustrialComponent, MarineComponent, MedicalPharmaceuticalAndDentalComponent, MiningComponent, NaturalGasComponent, OilAndGasComponent, PetrochemicalComponent, PlasticComponent, PowerComponent, RailComponent, SecurityAndFireComponent, WaterComponent]
})
