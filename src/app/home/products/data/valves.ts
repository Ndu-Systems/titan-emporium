...
export const valves: Array<Valve> = [
  //SOFT SEAT SAFETY VALVES
  {
    ...
    tableHeadings: ["Pressure Setting (PSI)	", "Flow (SCFM)	"],
    tableRows: [
      ["25", "17"],
      ["50", "28"],
      ["100", "51"],
 ...
 The difference between the CTC and the CTD is the CTD has an 1/8″ port on the side.
  Inlets range from 3/8″ to 3/4″ male (compression fitting). Outlets range from 3/8″ to 1″ male (NPT).`
    ...
    tableHeadings: ["Connection Inlet", "Connection Outlet", "Model #", "SCFM"],
    tableRows: [
      ["1/4", "1/2", "CTA1412", 20],
      ["3/8", "1/2", "CTA3812", "20"],
      ["1/2", "1/2", "CTA1212", "20"],
  ...
  },
  {
    ...
    tableHeadings: ["Connection Inlet", "Connection Outlet", "Model #", "SCFM"],
    tableRows: [["3/8", "1/2", "CAC3812", 20], ["1/2", "1/2", "CAC1212", "20"]]
  },
  {
    id: "tank-check-valves",
    name: "IN TANK CHECK VALVES",
  ...
  },
  {
    ...
    tableHeadings: [],
    tableRows: [["Super Seal is a pre-applied pipe sealant"]],
    tableAbbrevations:
      "A p1 (1/8″ port) and p2 (1/4″ port) are additional ports available on the CTB and CTD. These are also available on the CLB (In-Line check valve)."
  },
