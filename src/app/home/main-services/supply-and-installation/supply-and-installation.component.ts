...
export class SupplyAndInstallationComponent implements OnInit {
  paragraphs = [
    `Since The Titan Emporium (Pty) Ltd was established in 2012, there isn't much we have not come
    across in the supply and installation of compressed air systems.`,
    `We believe that you must start with the right parts and products and that's why we only supply
    market leading brands.`,
    `We can supply products including –`,
    ` -Compressors (rotary vane and rotary screw)`,
